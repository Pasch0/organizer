...
diretorios = ['compactados', 'imagens', 'videos', 'musicas', 'desenvolvimento', 'executaveis', 'texto']
...
organizer_path = '/home/pasch0/Downloads/organizer/' # Substitua para a pasta do organizador
